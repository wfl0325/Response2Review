...
#             # 对抗训练：添加扰动并计算对抗损失
#             # self.model.fgm.attack(epsilon=1.0, emb_name='bert.embeddings.word_embeddings')
#             # outputs_adv = self.model(bert_inputs, grid_mask2d, dist_inputs, pieces2word, sent_length)
#             # adv_loss = self.criterion(outputs_adv[grid_mask2d], grid_labels[grid_mask2d])
#             # adv_loss.backward()
#             # self.model.fgm.restore()  # 恢复参数
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='data/CmeEE.json')
    # parser.add_argument('--config', type=str, default='data/ontonotes4-zh.json')
